...
class svg_type():
    ...
    def default(self)->str:
        ...
        tail_width = self.width-self.head_length-self.border_radius*2-(self.border_radius-2)*2-self.connect_length
    ...
    def no_connect(self)->str:
        svg  = f"""<path fill="{self.color}" d="
            M{self.left}
            {self.top}
            v{self.height-ss.argument_border_radius*2}
            ...
            {ss.argument_border_radius}
            {ss.argument_border_radius}
            h{self.width-ss.argument_border_radius*2}
            a{ss.argument_border_radius}
            {ss.argument_border_radius}
            0
            0
